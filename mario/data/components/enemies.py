...
class Enemy(pg.sprite.Sprite):
    ...
    def walking(self):
        #default state of moving horizontally
    ...
    def start_death_jump(self, direction):
        #Transitions enemy into death state
        self.y_vel = -8
    ...
    def animation(self):
        #animation, switching between two frames
        self.image = self.frames[self.frame_index]
