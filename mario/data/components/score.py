...
class Score(object):
    ...
    def create_image_dict(self):
        #creates the dictionary for number images needed
        self.image_dict = {}
    ...
    def create_digit_list(self):
        #make group of images based on score received
        self.digit_list = []
    ...
    def set_rects_for_images(self):
        #Set the rect attributes for each image in image_list
    ...
    def check_to_delete_floating_scores(self, score_list, level_info):
        #check if scores need to be removed
