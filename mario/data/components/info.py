...
class OverheadInfo(object):
    ...
    def create_image_dict(self):
        #create initial images for score
        self.image_dict = {}
        image_list = []
    ...
    def create_score_group(self):
        #create the initial zero score
        self.score_images = []
        self.create_label(self.score_images, '000000', 75, 55)

    def create_info_labels(self):
        #create labels that describe each info
        self.mario_label = []
        self.world_label = []
        self.time_label = []
        self.stage_label = []
    ...
    def create_load_screen_labels(self):
        #create label for center info of a load screen
        world_label = []
        number_label = []
    ...
    def create_countdown_clock(self):
        #create count down clock for the level
    ...
    def set_label_rects(self, label_list, x, y):
        #set the location of each character
    ...
    def create_game_over_label(self):
        #create label for the game over screen
        game_label = []
        over_label = []
    ...
    def update_score_images(self, images, score):
        #update what numbers are to be blitted for score
        index = len(images) - 1
