...
class Menu(tools._State):
    def __init__(self):
        ...
        persist = {c.COIN_TOTAL: 0,c.SCORE: 0,c.LIVES: 3,c.TOP_SCORE: 0,c.CURRENT_TIME: 0.0,
                   c.LEVEL_STATE: None,c.CAMERA_START_X: 0,c.MARIO_DEAD: False}
    ...
    def setup_mario(self):
        #Places Mario at front of map 
        self.mario = mario.Mario()
        self.mario.rect.x = 110
        self.mario.rect.bottom = c.GROUND_HEIGHT

    def setup_background(self):
        #Setup background image to blit
        self.background = setup.GFX['level_1']
        self.background_rect = self.background.get_rect()
        self.background = pg.transform.scale(self.background,(int(self.background_rect.width*c.BACKGROUND_MULTIPLER),
    ...
    def reset_game_info(self):
        #Resets game info in case of a Game Over 
