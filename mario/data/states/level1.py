...
class Level1(tools._State):
    ...
    def setup_pipes(self):
        #create collideable rects for all pipes
    ...
    def setup_steps(self):
        ...
        self.step_group = pg.sprite.Group(step1,step2,step3,step4,step5,step6,step7,step8,step9,step10,step11,step12,
                                          step13,step14,step15,step16,step17,step18,step19,step20,step21,step22,
                                          step23,step24,step25,step26,step27)

    def setup_bricks(self):
        #creates all the breakable bricks. Coin and powerup groups are created so they can be passed to bricks.
        ...
        self.brick_group = pg.sprite.Group(brick1,brick2,brick3,brick4,brick5,brick6,brick7,brick8,brick9,brick10,
                                           brick11,brick12,brick13,brick14,brick15,brick16,brick17,brick18,brick19,
                                           brick20,brick21,brick22,brick23,brick24,brick25,brick26,brick27,brick28,
                                           brick29,brick30,brick31)
    ...
    def setup_coin_boxes(self):
        ...
        self.coin_box_group = pg.sprite.Group(coin_box1,  coin_box2,coin_box3,  coin_box4,coin_box5,  coin_box6,
                                              coin_box7,  coin_box8,coin_box9,  coin_box10,coin_box11, coin_box12)
    ...
    def setup_flag_pole(self):
        ...
        self.flag_pole_group = pg.sprite.Group(self.flag,finial,pole0,pole1,pole2,pole3,pole4,pole5,pole6,
                                               pole7,pole8,pole9)

    def setup_enemies(self):
        #creates all the enemies and stores them in a list 
        ...
        self.enemy_group_list = [enemy_group1,enemy_group2,enemy_group3,enemy_group4,enemy_group5,
                                 enemy_group6,enemy_group7,enemy_group8,enemy_group9,enemy_group10]
    ...
    def setup_checkpoints(self):
        #creates checkpoints that trigger the creation of enemies from the enemy list
        ...
        self.check_point_group = pg.sprite.Group(check1, check2, check3,check4, check5, check6,check7, 
